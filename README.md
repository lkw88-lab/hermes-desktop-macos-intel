...
| `Hermes-<version>-mac-x64.zip` | Plain archive of `Hermes.app` |
...
If you prefer the terminal after verifying `SHA256SUMS.txt`:
...
4. Publish a release with the DMG, ZIP, and SHA-256 checksums.
